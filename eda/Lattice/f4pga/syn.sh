...
nextpnr-${FPGA_FAM} -v --${FPGA_DEVICE} --package ${FPGA_PACKAGE} --json ${F4PGA_BUILD}/${TOP}.json --lpf ${ZIBAL_BUILD}/${TOP}.lpf --textcfg ${F4PGA_BUILD}/${TOP}.config --freq ${FPGA_FREQUENCY}
