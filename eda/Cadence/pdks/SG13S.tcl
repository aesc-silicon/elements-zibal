proc setup_library {} {
	set_db library "ng-stdcell/lib/ixc013ng_stdcell_typ_1p20V_25C.lib iocell/lib/ixc013_iocell_typ_1p2V_3p3V_25C.lib"

	set_db lef_library [list \
		ng-stdcell/lef/ixc013ng_tech.lef \
		ng-stdcell/lef/ixc013ng_stdcell_v5p7.lef \
		ng-stdcell/lef/ixc013ng_phys.lef \
...
proc get_lef_files {} {
	...
	set lef_files ${PATH_PDK}/ng-stdcell/lef/ixc013ng_tech.lef
	lappend lef_files ${PATH_PDK}/ng-stdcell/lef/ixc013ng_stdcell_v5p7.lef
	lappend lef_files ${PATH_PDK}/ng-stdcell/lef/ixc013ng_phys.lef
...
proc get_lib_min_files {} {
	...
	set timing_lib ${PATH_PDK}/ng-stdcell/lib/ixc013ng_stdcell_fast_1p32V_m40C.lib
	lappend timing_lib ${PATH_PDK}/iocell/lib/ixc013_iocell_fast_1p32V_3p6V_m40C.lib
...
proc get_lib_max_files {} {
	...
	set timing_lib ${PATH_PDK}/ng-stdcell/lib/ixc013ng_stdcell_slow_1p08V_125C.lib
	lappend timing_lib ${PATH_PDK}/iocell/lib/ixc013_iocell_slow_1p08V_3p0V_125C.lib
...
proc get_verilog_files {} {
	...
	set verilog_files ${PATH_PDK}/ng-stdcell/verilog/ixc013ng_primitives.v
	lappend verilog_files ${PATH_PDK}/ng-stdcell/verilog/ixc013ng_stdcell.v
