...
# Wrong pin because we only have three LEDs
set_property -dict { PACKAGE_PIN F5   IOSTANDARD LVCMOS33 } [get_ports { io_gpioStatus[3] }];
...
set_property -dict { PACKAGE_PIN M6  IOSTANDARD LVCMOS33 } [get_ports { io_spi0_ss }];    #SPI1_nCS L19P_14 -> CS#
