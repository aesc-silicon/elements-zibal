...
#set_property -dict { PACKAGE_PIN J5   IOSTANDARD LVCMOS33 } [get_ports { io_gpioStatus[3] }];
#set_property -dict { PACKAGE_PIN J4   IOSTANDARD LVCMOS33 } [get_ports { io_gpioStatus[4] }];
...
## SPI FLASH 
set_property -dict { PACKAGE_PIN N11  IOSTANDARD LVCMOS33 } [get_ports { io_spi0_sclk  }];		#SPI1_CLK L13P_14 -> SCK
set_property -dict { PACKAGE_PIN N9   IOSTANDARD LVCMOS33 } [get_ports { io_spi0_mosi  }];		#SPI1_D00 L18P_14 -> DQ0/SDI --> MOSI
set_property -dict { PACKAGE_PIN M6   IOSTANDARD LVCMOS33 } [get_ports { io_spi0_ss[0] }];		#SPI1_nCS L19P_14 -> CS#
set_property -dict { PACKAGE_PIN N6   IOSTANDARD LVCMOS33 } [get_ports { io_spi0_rst   }];		#SPI1_RST L19N_14 -> RST#/RFU
set_property -dict { PACKAGE_PIN P9   IOSTANDARD LVCMOS33 } [get_ports { io_spi0_miso  }];		#SPI1_D01 L18N_14 -> DQ1/SD0 --> MISO
set_property -dict { PACKAGE_PIN P8   IOSTANDARD LVCMOS33 } [get_ports { io_spi0_wp    }];		#SPI1_D02 L20P_14 -> WP#/DQ2 --> Write Protect 
set_property -dict { PACKAGE_PIN R8   IOSTANDARD LVCMOS33 } [get_ports { io_spi0_hold  }];		#SPI1_D03 L20N_14 -> DQ3/HOLD#/RST# --> HOLD
