...
create_clock -add -name sys_clk_pin -period 10 -waveform {0 5} [get_ports io_systemClock];
#create_generated_clock -name sys_clk_div2 -source [get_ports io_mainClk] -divide_by 2 \
#	[get_pins mainClk_reg/Q]
